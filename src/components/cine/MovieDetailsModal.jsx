  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen z-50 bg-black/60 backdrop-blur-sm">
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[984px] p-4 max-h-[90vh] overflow-auto">
        <div className={`h-full w-full ${darkMode ? "dark" : ""} bg-white shadow-md rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden`}>
          <img
          ...
          <div className="p-5 lg:p-11">
            ...
            <div className="grid lg:grid-cols-2 gap-2">
              ...
              <a
                className="border border-primary hover:bg-primary hover:text-[#171923] rounded-lg py-2 px-5 flex items-center justify-center gap-2 text-primary font-semibold text-sm"
                href="#"
                onClick={onClose}
              >
                Cancel
